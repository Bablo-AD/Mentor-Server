...
class Message_Completion_legacy(Resource):
    ...
    def post(self):
        ...
        model = PromptHandler(api_key=OPENAI_API_KEY,calibration_type="truncate")
        model.load(message)
        ...
        return make_response(jsonify({"response": output}), 200)
